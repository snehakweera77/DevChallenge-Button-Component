      ...
      <div className="mainPage__body">
        ...
        <div className="row">
          <div className="column">
            ...
            <ReusableButton color="primary" variant="outline" innerText="Default"></ReusableButton>
          </div>
          <div className="column">
            <p className="button-name hover-text">&:hover, &:focus</p>
            <ReusableButton hover="outline-hover" color="primary" variant="outline" innerText="Default"></ReusableButton>
          </div>
        </div>
        ...
        <div className="row">
          <div className="column">
            ...
            <ReusableButton color="primary" variant="text" innerText="Default"></ReusableButton>
          </div>

          <div className="column">
            <p className="button-name hover-text">&:hover, &:focus</p>
            <ReusableButton hover="text-hover" color="primary" variant="text" innerText="Default"></ReusableButton>
          </div>
        </div>
        ...
        <div className="row">
          <div className="column">
            ...
            <ReusableButton color="primary" disableShadow innerText="Default"></ReusableButton>
          </div>
        </div>
        ...
        <div className="row">
          ...
          <div className="column">
            ...
            <ReusableButton variant="text" disabled innerText="Disabled"></ReusableButton>
          </div>
        </div>
        ...
        <div className="row">
          <div className="column">
            ...
            <ReusableButton color="primary" startIcon="local_grocery_store" innerText="Default"></ReusableButton>
          </div>

          <div className="column">
            <p className="button-name">&lt;Button endIcon="local_grocery_store" /&gt;</p>
            <ReusableButton color="primary" endIcon="local_grocery_store" innerText="Default"></ReusableButton>
          </div>
        </div>
        ...
        <div className="row">
          ...
          <div className="column">
            ...
            <ReusableButton color="primary" innerText="Default"></ReusableButton>
          </div>
          <div className="column">
            <p className="button-name">&lt;Button color="secondary" /&gt;</p>
            <ReusableButton color="secondary" innerText="Secondary"></ReusableButton>
          </div>
          <div className="column">
        ...
        <div className="row">
          ...
          <ReusableButton hover="primary-hover" color="primary" innerText="Default"></ReusableButton>
          <ReusableButton hover="secondary-hover" color="secondary" innerText="Secondary"></ReusableButton>
          <ReusableButton hover="danger-hover" color="danger" innerText="Danger"></ReusableButton>
        </div>

      </div>
      <footer> Created by <a href="https://github.com/snehakweera77">snehakweera77</a> </footer>
    </div>
  );
}
